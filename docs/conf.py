#
# qq.py documentation build configuration file, created by
...
# pixels large.
html_favicon = './images/qq_py_logo.ico'
...
latex_documents = [
    ('index', 'qq.py.tex', 'qq.py Documentation',
     'foxwhite25', 'manual'),
]
...
man_pages = [
    ('index', 'qq.py', 'qq.py Documentation',
     ['foxwhite25'], 1)
]
...
texinfo_documents = [
    ('index', 'qq.py', 'qq.py Documentation',
     'foxwhite25', 'qq.py', 'One line description of project.',
     'Miscellaneous'),
]
...
def setup(app):
    if app.config.language == 'ja':
        ...
        app.config.html_context['qq_invite'] = 'https://qq.gg/nXzj3dg'
        app.config.resource_links['qq'] = 'https://qq.gg/nXzj3dg'
